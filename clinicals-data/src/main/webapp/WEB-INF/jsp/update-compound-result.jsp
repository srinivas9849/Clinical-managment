	...
	<div class="container">
		<div class=col-xs-md-14>
			...
			<div class=row
				...
				<form:form method="post" action="/update-result-to-patient" modelAttribute="result">
				   ...
				   <div class="form-group">
					...
					<div class="form-group">
						<label for="val">Value</label> <form:input type="text"
							cssClass="form-control" path="val" placeholder="Value"/>
					...
					<div class="form-group">
						<label for="date"></label> Taken Date<form:input type="date"
							cssClass="form-control" path="date" placeholder="date"/>
					<div><form:errors path="date" cssStyle="color: orange;font-size: 17px;"/></div>
						
					</div>
					
					<form:input type="number" cssStyle="visibility: hidden;"
							 path="compound_id" value="${c_id}"/>
